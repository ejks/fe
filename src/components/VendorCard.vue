			...
			>
				...
				<v-layout row class="ml-3 mr-3 mt-0 px-1 pt-0">
					...
					<v-row justify="space-around" class="mx-2 align-center">
						<v-switch
							inset
							@change="promotion.dialog3 = true"
							color="success"
						></v-switch>
						<v-dialog v-model="promotion.dialog3" max-width="290">
							<v-card>
								<v-layout row class="mx-auto">
									<v-card-title class="headline"
										>Activate promotion</v-card-title
									>
									<v-spacer></v-spacer>
									<v-btn icon @click="promotion.dialog3 = false">
										<v-icon>mdi-close</v-icon>
								...
								<v-form ref="form" v-model="valid" lazy-validation class="mx-5">
									<v-checkbox v-model="allday" color="green">
										<template v-slot:label>
											<div>
												All day promotion
											</div>
								...
								<v-card-actions class="d-flex justify-space-around pb-3">
									<v-btn
										...
										class="buttons"
										depressed
										@click="(promotion.dialog3 = false), (snackbar = true)"
									>
										save & post
									</v-btn>
									<v-snackbar v-model="snackbar" color="success">
										You have successfully activated this promotion. It is now
										live and is viseble for customers!
										<v-btn
											vertical
											text
											dark
						...
						<v-dialog v-model="promotion.dialog2" max-width="290">
							<v-card>
								...
								<v-form ref="form" v-model="valid" lazy-validation class="mx-5">
									...
									<v-textarea v-model="description" color="#DFA937">
										<template v-slot:label>
											<div>
												Description
											</div>
                  ...
                  ></v-text-field> -->
								...
								<v-card-actions class="d-flex justify-space-around pb-3">
									...
									<v-snackbar v-model="snackbar">
										You have successfully edited this promotion. Toggle the
										switch to make the promotion live and visable for customers!
										<v-btn
											color="success"
											vertical
											text
						...
						<v-dialog v-model="promotion.dialog" max-width="290">
							<v-card>
								...
								<v-card-text>
									Are you sure you want to cancel this promotion? This action is
									permanent.
								</v-card-text>
						...
						<v-snackbar v-model="snackbar">
							You have successfully activated this promotion. It is now live and
							is viseble for customers!
							<v-btn
								color="success"
								vertical
								text
